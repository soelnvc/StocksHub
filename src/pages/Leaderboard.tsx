    ...
    <Layout>
      <div className="flex flex-col items-center justify-center h-full text-center p-4">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
          See who's topping the charts with the highest total profit/loss across all holdings!
        </p>
        ...
        <Card className="w-full max-w-2xl bg-white dark:bg-gray-800 shadow-lg">
          <CardHeader className="border-b dark:border-gray-700">
            <CardTitle className="text-xl font-semibold text-gray-900 dark:text-white flex items-center space-x-2">
              ...
              <span>Top Traders by Total P/L</span>
            </CardTitle>
          </CardHeader>
                    ...
                    {leaderboard.map((entry) => (
                      ...
                      >
                        ...
                        <TableCell className="text-right">
                          {formatCurrency(entry.total_portfolio_profit_loss)}
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
